...
/// <summary>
/// Request Macro Panel Keys Public State (HCIv2) - Message ID 0x0172 (370).
/// This message is used to get the current state (latched state) of the
/// Dynam-EC macro keys on the specified panel.
/// </summary>
public class RequestMacroPanelKeysPublicStateRequest : HCIRequest
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new Request Macro Panel Keys Public State for all panels.
    /// </summary>
    public RequestMacroPanelKeysPublicStateRequest()
        : base(HCIMessageID.RequestMacroPanelKeysPublicState)
    {
    }

    /// <summary>
    /// Creates a new Request Macro Panel Keys Public State for a specific panel.
    /// </summary>
    /// <param name="portNumber">The port number of the panel, or 65535 for all panels.</param>
    public RequestMacroPanelKeysPublicStateRequest(ushort portNumber)
        : base(HCIMessageID.RequestMacroPanelKeysPublicState)
    {
